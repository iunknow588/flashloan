...
async function main() {
  ...
  const paths = evidencePaths({ strategy: "fuji-aave-executor-deploy" });
  ...
  const deploymentPath = path.join(outputDir, "fuji-aave-executor.json");
  const output = {
    runId: paths.runId,
