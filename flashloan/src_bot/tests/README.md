...
- `test_cow_routes.py` - CoW路由评估
- `test_cow_flashloan_capabilities.py` - 闪电贷能力评估
...
- `test_page_state_service.py` - 页面状态服务
- `test_control_panel_data_extremes.py` - 数据极值展示
- `test_binance_market_service.py` - 币安市场服务
- `test_observer_runtime_service.py` - 运行时服务（启动进度、心跳）
- `test_liquidation_web_helpers.py` - Web辅助函数
