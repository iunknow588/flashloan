...
def test_liquidation_contracts_bot_dir_prefers_contract_root(monkeypatch, tmp_path):
    ...
    legacy_dir = tmp_path / "contracts-bot"
...
def test_liquidation_contracts_bot_dir_falls_back_to_legacy_root(monkeypatch, tmp_path):
    from web import control_panel_liquidation_execute as execute
    ...
    assert execute.liquidation_contracts_bot_dir() == legacy_dir
